...
public class QueueHelper {
    ...
    public static List<MediaSessionCompat.QueueItem> getPlayingQueue(MusicProvider musicProvider) {
        ...
        List<MutableMediaMetadata> list = new ArrayList<>();
        Set<Map.Entry<String, MutableMediaMetadata>> entries = musicProvider
                .getmMusicListById().entrySet();
        for (Map.Entry<String, MutableMediaMetadata> e : entries) {
            list.add(e.getValue());
        }
    ...
    private static List<MediaSessionCompat.QueueItem> convertToQueue(List<MutableMediaMetadata>
                                                                             tracks) {
        ...
        for (MutableMediaMetadata track : tracks) {
            ...
            MediaMetadataCompat trackCopy = new MediaMetadataCompat.Builder(track.metadata)
                    .putString(MediaMetadataCompat.METADATA_KEY_MEDIA_ID, track.songInfo.getId())
                    .build();
