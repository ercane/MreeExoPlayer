...
import mree.exo.player.utils.MediaIDHelper;
import mree.exo.player.utils.QueueHelper;
...
public class QueueManager {
    ...
    public void updateMetadata() {
        ...
        MediaMetadataCompat metadata = mMusicProvider.getMusic(musicId).metadata;
        if (metadata == null) {
